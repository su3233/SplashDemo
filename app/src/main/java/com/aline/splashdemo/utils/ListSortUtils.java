...
//            int num3 =(Integer) value1;
//            long num2 = Integer.parseInt(str2);
            int maxlen2 = Math.max(str1.length(), str2.length());
            str1 = ListSortUtils.addZero2Str((Number) value1, maxlen2);
            str2 = ListSortUtils.addZero2Str((Number) value2, maxlen2);
        }
        if (isAsc) {
